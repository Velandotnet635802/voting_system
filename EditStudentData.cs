...
namespace college_chairman_voting_system
{
    public partial class EditStudentData : Form
    {
        ...
        private void loginbtn_Click(object sender, EventArgs e)
        {
            try
            {
                if (stuidcardtxt.Text == "" || stnametxt.Text == "" || departmenttxt.Text == "" || emailtxt.Text == "")
                {
                ...
                else
                {
                    ...
                    con.Open();
                    SqlCommand cmd = new SqlCommand("sp_stu_update", con);
                    cmd.CommandType = CommandType.StoredProcedure;

                    SqlParameter param1 = new SqlParameter("@stu_idcard_no", SqlDbType.VarChar);
                    cmd.Parameters.Add(param1).Value = stuidcardtxt.Text;
                    SqlParameter param2 = new SqlParameter("@stu_name", SqlDbType.VarChar);
                    cmd.Parameters.Add(param2).Value = stnametxt.Text;
